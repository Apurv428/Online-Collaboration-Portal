...
class EditorPage extends React.Component {
  ...
  UpdateProgram = async () => {
    const res = await fetch("http://localhost:5000/updateProgram", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  DeleteProgram = async () => {
    const res = await fetch("http://localhost:5000/removeProgram", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  async getData() {
    ...
    const getSpaceProgramsURL =
      "http://localhost:5000/viewSpacePrograms/" + `${token}`;
    console.log("Getting Data");
    axios
      .get(`${getSpaceProgramsURL}`)
      .then((res) => {
