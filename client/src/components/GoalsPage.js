...
class GoalsPage extends React.Component {
  ...
  async getData() {
    ...
    const getSpaceGoalsURL = "http://localhost:5000/viewSpaceGoals/" + `${token}`;
  ...
  AddNewGoal = async () => {
    ...
    const res = await fetch("http://localhost:5000/addGoal", {
      method: "POST",
      headers: {
  ...
  confirmGoal = async () => {
    const res = await fetch("http://localhost:5000/updateGoal", {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
  ...
  removeGoal = async () => {
    const res = await fetch("http://localhost:5000/removeGoal", {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
  ...
  async componentDidMount() {
    ...
    const getSpaceDataURL = "http://localhost:5000/overview/" + `${localStorage.getItem('token')}`;
    this.getData();
  ...
  //  fetch('http://localhost:5000/overview').then(res=>res.json())
  //  .then(res2=>{
  //         console.log(res2);
  //  });
  // Trigger update
